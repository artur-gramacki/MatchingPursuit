...
For simplicity, all four steps described above have been encapsulated in a single function, `run_mp_omp_pipeline()`, which returns an object of class `mp`.

```{r run_mp_omp_pipeline, include = TRUE, echo = TRUE, warning = FALSE, fig.width = 7, fig.height = 7}
out <- run_mp_omp_pipeline(
   mode = 'omp',
   sig_file = sig_file,

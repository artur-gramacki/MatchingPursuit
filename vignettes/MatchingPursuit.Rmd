...
Generating the final time-frequency map for the selected channel (`r ch <- 1; colnames(bip.montage.filt)[ch]`). The centers of atoms (in the sense of time and frequency coordinates) are now marked with white crosses. 

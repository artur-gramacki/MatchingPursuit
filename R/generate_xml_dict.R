...
#' and the largest window length is the largest odd integer not exceeding \code{N - 1}
#'
...
#' \code{read_gabor_dict()} function and the corresponding vignette available on CRAN).
#'
#' \enumerate{

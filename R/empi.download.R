...
#' \href{https://github.com/develancer/empi}{empi}. Details are presented in a journal
#' paper: Różański, P.T. (2024). \emph{empi: GPU-Accelerated Matching Pursuit with Continuous Dictionaries}.
